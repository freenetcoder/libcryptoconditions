/*****************************************************************
 *                            *******                            *
 * Copyright © 2017-2018 S. Thomas, R. Reginelli, A. Hope-Bailie *
 * Crypto-Conditions - draft-thomas-crypto-conditions-03         *
 * https://tools.ietf.org/html/draft-thomas-crypto-conditions-03 *
 * https://github.com/ssadler Interledger crypto-conditions      *
 * implemented in C                                              *
 *               Copyright © 2019 EOX Co. developers             *
 *                            *******                            *
 *****************************************************************/
